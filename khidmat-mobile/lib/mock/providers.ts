...
export const providers: Provider[] = [
  ...
  // ── KPK / Mardan & Peshawar Providers ──────────────
  {
    id: 'p016',
    name: 'Khan AC & Electrician Mardan',
    category: 'ac',
    sector: 'Mardan',
    coords: { lat: 34.1986, lng: 72.0404 },
    rating: 4.8,
    reviewCount: 95,
    yearsExperience: 7,
    priceRange: 'PKR 1500-3500',
    phone: '+92-300-1122334',
    availableSlots: ['10:00 AM', '2:00 PM', '5:00 PM'],
  },
  {
    id: 'p017',
    name: 'Mardan Plumber Services',
    category: 'plumber',
    sector: 'Mardan',
    coords: { lat: 34.2001, lng: 72.0425 },
    rating: 4.6,
    reviewCount: 78,
    yearsExperience: 6,
    priceRange: 'PKR 1000-2500',
  ...
  {
    id: 'p018',
    name: 'Peshawar Solar & Bijli Master',
    category: 'electrician',
    sector: 'Peshawar',
