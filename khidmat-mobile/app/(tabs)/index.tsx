  ...
  if (isAuthenticated && user?.role === 'provider') {
    return (
      <SafeAreaView className="flex-1 bg-white" edges={['top']}>
        <ProviderDashboardView user={user} />
      </SafeAreaView>
    );
  }
      ...
      >
        ...
        <View className="flex-row items-center justify-between border-b border-gray-50 px-5 pb-3 pt-2">
          ...
          <View className="flex-row items-center gap-2">
            ...
            {/* Auth User Pill / Avatar Badge */}
            {isAuthenticated && user ? (
              <TouchableOpacity
                onPress={() => router.push('/auth')}
                className="flex-row items-center gap-2 rounded-full bg-orange-50 px-3 py-1.5 border border-orange-200/80 active:bg-orange-100"
              >
              ...
              <TouchableOpacity
                onPress={() => router.push('/auth')}
                className="rounded-full bg-primary px-3 py-1.5 active:bg-primary/90"
              >
